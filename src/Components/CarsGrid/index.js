...
const CarBox = ({id,title,image,to,classes}) => {
    ...
    return (<Grid item xs={6} md={4} className={classes.carItem}>
...
const CarsGrid = ({cars}) => {
    ...
    return (<Grid container spacing={0} className={classes.carsGrid} direction="row" justify="center" alignItems="stretch">
        {cars.map((car,inx)=>{
